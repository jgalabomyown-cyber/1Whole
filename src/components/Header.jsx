...
export default function Header({ onSidebar }) {
  const { activeTrack, switchWorkspace, trackCatalog, goToNotes, goToWorkspace, goToProfile, searchTerm, setSearchTerm, user, userProfile } = useAppContext();
